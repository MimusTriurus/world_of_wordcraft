...
// Обойма на старте пуста, и слоты закрыты: каждый открывается тогда, когда его
// нужда впервые появится на поле, — см. tools/ai/draft-check.mjs.
ok("обойма на старте пуста",
   g.shells === 0 && g.bombs === 0 && g.tips === 0 && g.unlocked.size === 0);
run(60);
